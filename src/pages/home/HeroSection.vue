					...
					<div class="col--12 col--lg-6">
						<div class="hero-sec__content">
							<h1 class="hero-sec__title">
								Grow your Business with our SEO solution
							</h1>
							<p class="hero-sec__desc">
								We are a full-service Digital Marketing Agency
								with all the foundational tools you need for
								inbound success. With this module, there's no
								need to go another day.
							</p>
							<base-button
								link
								href="#"
								class="btn btn--outline-white btn--large"
							>
								Learn More
							</base-button>
						</div>
